...
feeds = [
    # Google Play Feeds
    {:id => '1', :name => 'Paid'    , :code => 'topselling_paid'    , :market_id => '1'},
    {:id => '2', :name => 'Free'    , :code => 'topselling_free'    , :market_id => '1'},
    ...
    # iOS Feeds
    {:id => '6',:name => 'Paid'    , :code => 'toppaidapplications'    , :market_id => '2'},
    {:id => '7',:name => 'Free'    , :code => 'topfreeapplications'    , :market_id => '2'},
